...
self.addEventListener('push', (event) => {
  ...
  try {
    ...
    payload = { title: 'FastMart Admin', body: event.data.text() }
  }
  ...
  event.waitUntil(
    self.registration.showNotification(payload.title || 'FastMart Admin', options)
  )
})
