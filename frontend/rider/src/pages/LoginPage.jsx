  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (profile.data.role !== 'rider') {
        localStorage.clear(); setError('This app is for riders only.'); return
      }
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-sm">
        {step === 'login' ? (
          <>
            <h1 className="text-2xl font-bold mb-2">🛵 FastMart Rider</h1>
            <p className="text-gray-500 text-sm mb-6">Sign in to start your shift</p>
            ...
            <p className="mt-4 text-sm text-center text-gray-600">
              Don't have an account? <Link to="/register" className="text-orange-500 font-medium hover:underline">Sign up as a rider</Link>
            </p>
          </>
        ) : (
          ...
          <>
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 text-sm">
                Get instant updates on order assignments, delivery status, and earnings.
              </p>
            </div>
